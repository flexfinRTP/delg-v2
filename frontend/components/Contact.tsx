import {
  ...
  export default function ContactFormWithSocialButtons() {
    const { hasCopied, onCopy } = useClipboard('support@datalinkdao.com');
            ...
            <VStack spacing={{ base: 4, md: 8, lg: 20 }}>
              ...
              <Stack
                ...
                <Stack
                  ...
                  <Link href="https://github.com/DataLink-DAO">
                    <IconButton
                      aria-label="github"
                      variant="ghost"
                      size="lg"
                  ...
                  <Link href="https://www.linkedin.com/company/datalink-dao">
                    <IconButton
                      aria-label="linkedin"
                      variant="ghost"
                      size="lg"
